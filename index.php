...
{
	die("PHP 8.0.0 or newer is required, your server has " . phpversion() . ". Please ask your host to upgrade PHP.");
}
...
foreach (array('boardurl', 'boarddir', 'sourcedir', 'packagesdir', 'cachedir') as $variable)
