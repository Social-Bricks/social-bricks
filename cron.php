...
global $db_server, $db_name, $db_user, $db_prefix, $db_persist, $db_last_error;
...
set_error_handler('sb_error_handler_cron');
$sc = '';
 ...
 * @return void
 */
function sb_error_handler_cron($error_level, $error_string, $file, $line)
{
	global $modSettings;
