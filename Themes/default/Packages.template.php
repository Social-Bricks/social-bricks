...
function template_view_package()
{
	...
	echo '
		<form action="', !empty($context['post_url']) ? $context['post_url'] : '#', '" onsubmit="submitonce(this);" method="post" accept-charset="UTF-8" id="view_package">
			<div class="cat_bar">
				<h3 class="catbg">
...
function template_servers()
{
	...
	<div id="admin_form_wrapper">
		...
		<div class="windowbg">
			<form action="', $scripturl, '?action=admin;area=packages;get;sa=upload" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
				<dl class="settings">
					<dt>
