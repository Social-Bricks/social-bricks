...
function sb_PersonalMessageSend(oOptions)
{
	this.opt = oOptions;
	this.oBccDiv = null;
	this.oBccDiv2 = null;
...
sb_PersonalMessageSend.prototype.init = function()
{
	...
	this.oToAutoSuggest = new sb_autoSuggest({
	...
	this.oBccAutoSuggest = new sb_autoSuggest({
...
sb_PersonalMessageSend.prototype.showBcc = function()
{
...
sb_PersonalMessageSend.prototype.callbackAddItem = function(oAutoSuggestInstance, sSuggestId)
{
