function sb_Register(formID, passwordDifficultyLevel, regTextStrings)
{
	...
	function checkUsername(is_auto)
	{
		...
		getXMLDocument(sb_prepareScriptUrl(sb_scripturl) + 'action=signup;sa=usernamecheck;xml;username=' + checkName, checkUsernameCallback);
