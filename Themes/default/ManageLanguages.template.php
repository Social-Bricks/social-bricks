...
function template_modify_language_entries()
{
	...
	echo '
		<form action="', $scripturl, '?action=admin;area=languages;sa=editlang;lid=', $context['lang_id'], '" id="primary_settings" method="post" accept-charset="UTF-8">
			<div class="cat_bar">
				<h3 class="catbg">
					', $txt['edit_languages'], '
				</h3>
...
function template_add_language()
{
	...
	if (!empty($context['sb_error']))
		echo '
					<div>
						<br>
						<p class="errorbox">', $txt['add_language_error_' . $context['sb_error']], '</p>
					</div>';
