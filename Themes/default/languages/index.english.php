...
$txt['not_removed_extra'] = '%1$s is a backup of %2$s that was not generated by Social Bricks. It can be accessed directly and used to gain unauthorized access to your forum. You should delete it immediately.';
...
$txt['auth_secret_missing'] = 'Unable to set authentication secret in Settings.php. This weakens the security of your forum and puts it at risk for attacks. Check the file permissions on Settings.php to make sure Social Bricks can write to the file.';
...
// argument(s): SB_FULL_VERSION, SB_SOFTWARE_YEAR
$forum_copyright = '%1$s &copy; %2$s, <a href="https://socialbricks.org" title="Social Bricks" target="_blank" rel="noopener">Social Bricks</a>';
