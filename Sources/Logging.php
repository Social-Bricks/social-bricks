...
function writeLog($force = false)
{
	...
	// Grab the last all-of-Social Bricks-specific log_online deletion time.
	...
	if (SOCIALBRICKS != 'SSI' && !empty($user_info['last_login']) && $user_info['last_login'] < time() - 60 && (!isset($_REQUEST['action']) || !in_array($_REQUEST['action'], array('.xml', 'login2', 'logintfa'))))
	{
...
/**
 * Log multiple changes to the forum, such as moderation events or administrative
 * changes.
 *
 * Social Bricks uses three log types:
 *
